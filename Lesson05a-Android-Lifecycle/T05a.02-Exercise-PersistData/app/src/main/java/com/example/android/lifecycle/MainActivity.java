...
public class MainActivity extends AppCompatActivity {
    ...
    private String LIFECYCLE_CALLBACKS_TEXT_KEY = "LIFECYCLE_CALLBACKS_TEXT_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String restoredText = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            if (restoredText != null) {
                mLifecycleDisplay.setText(restoredText);
            }
        }
