...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DroidTermsContentProviderAsyncTask task = new DroidTermsContentProviderAsyncTask();
        task.execute();
    ...
    class DroidTermsContentProviderAsyncTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            mData = cursor;
            Log.d(LOG_TAG, "cursor has " + cursor.getCount() + "tuples");
        }
    }
