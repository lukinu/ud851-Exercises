...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 1;
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "main notifications";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        manager.notify(WATER_REMINDER_NOTIFICATION_ID, notificationBuilder.build());
    }
