...
public class NotificationUtils {
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        Intent actionIgnoreNotificationIntent = new Intent(context, WaterReminderIntentService.class);
        //      TODO (7) Set the action of the intent to designate you want to dismiss the notification
        actionIgnoreNotificationIntent.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
        //      TODO (8) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent actionIgnorePendingIntent = PendingIntent.getService(
                context,
                ACTION_IGNORE_PENDING_INTENT_ID,
                actionIgnoreNotificationIntent,
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        Intent actionDrinkWaterNotificationIntent = new Intent(context, WaterReminderIntentService.class);
        //      TODO (13) Set the action of the intent to designate you want to increment the water count
        actionDrinkWaterNotificationIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        //      TODO (14) Create a PendingIntent from the intent to launch WaterReminderIntentService
        PendingIntent actionIncrementPendingIntent = PendingIntent.getService(
                context,
                ACTION_DRINK_PENDING_INTENT_ID,
                actionDrinkWaterNotificationIntent,
