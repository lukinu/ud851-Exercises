...
public class SettingsFragment extends PreferenceFragmentCompat implements OnSharedPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        Integer countOfPreferences = preferenceScreen.getPreferenceCount();
    ...
    public void setPreferenceSummary(Preference preference, String value) {
        if (preference instanceof ListPreference) {
            Integer index = ((ListPreference) preference).findIndexOfValue(value);
            if (index >= 0) {
                String label = ((ListPreference) preference).getEntries()[index].toString();
