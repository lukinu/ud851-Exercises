...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getResources().getString(R.string.pref_show_bass_key))) {
            Boolean defaultSetting = getResources().getBoolean(R.bool.pref_show_bass_default);
            Boolean setting = sharedPreferences.getBoolean(key, defaultSetting);
            mVisualizerView.setShowBass(setting);
        }
    }
